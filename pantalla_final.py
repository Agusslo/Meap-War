...
def mostrar_pantalla_final(medidas_pantalla, dict_puntaje:dict):
    '''brief: configuracion de la pantalla de muerte'''
    pantalla = pygame.display.set_mode(medidas_pantalla)
    pygame.display.set_caption("Meap War")
    clock = pygame.time.Clock()

    fondo = pygame.image.load("recursos\\space_finish.png")
    ...
    #musica
    pygame.mixer.music.load("recursos\sonidos\pantalla_final.mp3")
    pygame.mixer.music.play(-1)
    pygame.mixer.music.set_volume(0.08)

    #mousse
    new_mousse = pygame.image.load("recursos\mouse.png")
    ...
    while running:
        ...
        texto_bonus_tiempo = fuente_puntaje.render(f"Bonus por tiempo: {bonus_tiempo}", True, (WHITE))
        texto_puntaje_juego = fuente_puntaje.render(f"Puntaje del juego: {puntaje_juego}", True, (WHITE))
        texto_puntaje_total = fuente_titulo.render(f"Puntaje total: {puntaje_final}", True, (WHITE))
        ...
        texto_ingresar_nombre = fuente_puntaje.render("Ingrese nombre:", True, (WHITE))
        pantalla.blit(texto_ingresar_nombre, ((medidas_pantalla[0] // 2) - 120, 300))

        texto_letras = fuente_puntaje.render(f"{letra_1 or '_'} {letra_2 or '_'} {letra_3 or '_'}", True, (RED))
        pantalla.blit(texto_letras, ((medidas_pantalla[0] // 2) - 50, 370))
        ...
        texto = fuente.render("Volver a jugar", True, (WHITE))
        ...
        if carga:
            texto = fuente_puntaje.render("Se cargo correctamente", True, (WHITE))
            pantalla.blit(texto, ((medidas_pantalla[0] // 2) - 160, 750))
            volvio_a_cargar = True
        else:
            texto = fuente_puntaje.render("Se deben ingresar las 3 letras para poder guardar.", True, (WHITE))
