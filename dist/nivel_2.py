...
def nivel_2():
    '''brief: configuraciones del nivel 2'''
    pygame.init()
    #PANTALLA
    ancho_pantalla = 1250
    alto_pantalla = 650
    ...
    posicion_portal = (470, 100)
    portal_terminar_nivel = Portal(medidas_portal, posicion_portal) #PORTAL
    ...
    #plataforma 2
    medidas_plataformas_2 = (300,30)
    lugar_p2 = (650, 470)
    p_2 = Plataforma(medidas_plataformas_2, path_base, lugar_p2)
    #plataforma 3
    medidas_plataformas_3 = (300,30)
    lugar_p3 = (900, 350)
    ...
    #plataforma 5
    medidas_plataformas_5 = (350,30)
    lugar_p5 = (600, 150)
    p_5 = Plataforma(medidas_plataformas_5, path_base, lugar_p5)

    

    lista_plataformas_con_monedas = [p_1, p_2,p_3,p_4,p_5]
    ...
    diccionario_animaciones_enemigo["camina_derecha"] = lista_enemigo_dos_caminar_derecha
    diccionario_animaciones_enemigo["camina_izquierda"] = lista_enemigo_dos_caminar_izquierda
    diccionario_animaciones_enemigo["recibir_daño"] = lista_enemigo_dos_recibir_daño
    diccionario_animaciones_enemigo["recibir_daño_izquierda"] = lista_enemigo_dos_recibir_daño_izquierda = girar_imagen(lista_enemigo_dos_recibir_daño, True, False)
    diccionario_animaciones_enemigo["atacar"] = lista_enemigo_dos_atacar
    diccionario_animaciones_enemigo["atacar_izquierda"] = lista_enemigo_dos_atacar_izquierda 
    ...
    vida_enemigo_2 = 16
    enemigo_2 = Enemigo(tamaño_enemigo_2,diccionario_animaciones_enemigo,velocidad_enemigo_2, p_2, puntuacion_enemigo_2, vida_enemigo_2)
    #ENEMIGO 3
    velocidad_enemigo_3 = 6
    tamaño_enemigo_3 = (85,65)
    puntuacion_enemigo_3 = 20
    vida_enemigo_3 = 16
    enemigo_3 = Enemigo(tamaño_enemigo_3, diccionario_animaciones_enemigo,velocidad_enemigo_3, p_3, puntuacion_enemigo_3, vida_enemigo_3)
    #ENEMIGO 4
    velocidad_enemigo_4 = 10
    tamaño_enemigo_4 = (85,65)
    puntuacion_enemigo_4 = 20
    vida_enemigo_4 = 16
    enemigo_4 = Enemigo(tamaño_enemigo_4, diccionario_animaciones_enemigo,velocidad_enemigo_4, p_5, puntuacion_enemigo_4, vida_enemigo_4)
    ...
    while run:
        if not pausa:
            ...
            if get_modo():
                ...
                enemigo_4.dibujar_hitbox(pantalla)
