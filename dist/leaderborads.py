...
def leaderbord(medidas_pantalla):
    '''brief: configuracion de la pantalla de puntajes'''
    pantalla = pygame.display.set_mode(medidas_pantalla)
    pygame.display.set_caption("Meap War")
    clock = pygame.time.Clock()

    #musica
    pygame.mixer.music.load("recursos\sonidos\leaderboards.mp3")
    ...
    fondo_base = pygame.image.load("recursos\origbig.png")
    ...
    gold_medal = pygame.image.load("recursos\medallas\medal_02_gold.png")
    gold_medal = pygame.transform.scale(gold_medal,medidas_medallas)
    silver_medal = pygame.image.load("recursos\medallas\medal_02_silver.png")
    silver_medal = pygame.transform.scale(silver_medal,medidas_medallas)
    bronze_medal = pygame.image.load("recursos\medallas\medal_02_bronze.png")
