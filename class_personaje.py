...
class Personaje():
    def __init__(self, tamaño, animaciones, posicion_inicial, velocidad, sonidos):
        ...
        self.img_corazon = pygame.image.load('recursos\corazon.png')
...
#METODOS
    def reproducion_sonido(self, clave, volumen):
        '''brief: reproduce el sonido que le pase por parametro'''
    ...
    def animar(self, pantalla, que_animacion:str):
        '''brief: anima el personaje segun lo que pase por parametro'''
    ...
    def aplicar_gravedad(self, pantalla):
        '''brief: aplica la gravedad del personaje para que no salga volando cuando salte'''
    ...
    def detectar_colision(self,plataformas):
        '''brief: detecta la colision con las plataformas(arriba/abajo/izq/der)'''
        for plataforma in plataformas:
            if self.lados['main'].colliderect(plataforma.lados['bottom']):
                self.lados['main'].top = plataforma.lados['bottom'].bottom 
    ...
    def mover(self, velocidad):
        '''brief:mueve al personaje en el eje x'''
        for lado in self.lados:
    ...
    def update(self, pantalla, piso):
        ...
        if keys[pygame.K_d]:
            ...
            if not self.esta_saltando:#deja moverme en el aire
    ...
    def ejecutar_animaciones(self, pantalla):
        '''brief: ejecuta las animacion de que_hace'''
    ...
    def detectar_bordes_pantalla(self,pantalla):
        '''brief: detecta los bordes de la pantalla para que no se "vaya del juego"'''
    ...
    def dibujar_hitbox(self,pantalla):
        '''brief: dibuja la hitbox del personaje'''
        for lado in self.lados:
            pygame.draw.rect(pantalla,ORANGE,self.lados[lado],1)
    ...
    def asignar_score(self, score):
        '''brief: asigna el score'''
        self.score = score

    def dibujar_vida_en_pantalla(self, pantalla):
        '''brief: dibuja los corazones en la pantalla'''
        x = (pantalla.get_width() // 2) - 150
